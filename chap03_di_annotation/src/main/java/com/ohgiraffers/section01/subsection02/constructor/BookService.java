...
/* @Service : @Component의 세분화 어노테이션의 한 종류로 Service 게층에서 사용한다. */

@Service("bookServiceConstructor")
public class BookService {

    private final BookDAO bookDAO; // final 이므로 생성자 기반으로 해주어야 한다.
    ...
    * 위의 코드에서 기본 생성자를 추가로 작성하고 매개변수 생성자에 @Autowired 어노테이션을 생략하게 되면
    * 생성자 주입이 동작하지 않아 오류가 발생된다.
    *
    * 생성자 주입의 장점
